...
export type ControlledFormInput<T extends Record<string, string | number>> =
	Omit<UseControllerProps, "control"> & InputProps & { control: Control<T> };
							...
							default:
								return (
									<Input
										...
										fontSize={"lg"}
										value={
											inputType === "Currency" && isNumber(field.value)
												? (Number(field.value) / 100).toLocaleString("en-US", {
														style: "currency",
														currency: "USD",
												  })
												: field.value || ""
