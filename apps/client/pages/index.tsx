...
export default function Index() {
	...
	return (
		<>
			...
			<meta content={t("og-title")} property="og:title" />
			<meta content={t("og-description")} property="og:description" />
			<meta
				content="https://uploads-ssl.webflow.com/6480b8939d58cca063ed09c9/64ad80cc471cc7fb1c560f07_Fasto%20Logo.png"
				property="og:image"
			/>
			<meta content={t("og-title")} property="twitter:title" />
			<meta content={t("og-description")} property="twitter:description" />
			<meta
				content="https://uploads-ssl.webflow.com/6480b8939d58cca063ed09c9/64ad80cc471cc7fb1c560f07_Fasto%20Logo.png"
			...
			<div className="page-content" style={{ overflow: "scroll" }}>
				...
				<section className="hero wf-section">
					...
					>
						<div className="w-layout-hflex flex-block-navbar">
							<Link href={"/"}>
								<a aria-current="page" className="logo w-nav-brand w--current">
									<img
							...
							<nav role="navigation" className="w-nav-menu">
								<Link href="#How-it-works">
									<a className="nav-link w-nav-link">{t("how-it-works")}</a>
								</Link>
								...
								<Link href="#Pricing">
									<a className="nav-link w-nav-link">{t("pricing")}</a>
								</Link>
								<Link href="partners">
									<a className="nav-link w-nav-link">{t("partners")}</a>
								</Link>
							</nav>
							<Link href="business/login">
								<a className="link-block w-inline-block">
									<img
										src="html/images/Login-grad.webp"
										loading="lazy"
										alt=""
									/>
								</a>
					...
					>
						...
						>
							<div className="text-hero-wrapper">
								...
								<p className="paragraph">{t("hero-subtitle")}</p>
								<Link href="business/signup">
									<a className="button w-button">{t("hero-cta")}</a>
								</Link>
							</div>
						</div>
						<div
					...
					<div className="content-container">
						...
						<div className="w-layout-hflex business-features-box">
							...
							<div className="text-wrapper-column">
								<p className="paragraph dark">{t("how-it-works-subtitle")}</p>
							</div>
						</div>
					</div>
				</section>
				...
				<section id="Features-and-benefits" className="section wf-section">
					<div className="w-layout-hflex client-feature-box">
						...
						<div className="feature-card margin-left">
							...
							<p className="paragraph dark">{t("increased-efficiency-text")}</p>
						</div>
					</div>
					<div className="w-layout-hflex client-feature-box">
						<div className="feature-card margin-right">
							<h3 className="heading-3">{t("flexible-payment")}</h3>
							<p className="paragraph dark">{t("flexible-payment-text")}</p>
						</div>
						<img
				...
				<section className="section dark wf-section">
					<div className="content-container">
						<h2 className="heading-2">{t("qa-title")}</h2>
						<div className="dropdown-wrapper">
							...
							>
								<div className="dropdown-toggle w-dropdown-toggle">
									...
									<div className="paragraph">{t("qa-1")}</div>
								</div>
							...
							<div data-hover="false" data-delay={0} className="w-dropdown">
								<div className="dropdown-toggle w-dropdown-toggle">
									<div className="icon w-icon-dropdown-toggle" />
									<div className="paragraph">{t("qa-2")}</div>
								</div>
								<nav className="w-dropdown-list">
									<a href="#" className="dropdown-link w-dropdown-link">
										{t("qa-2-text")}
							...
							>
								<div className="dropdown-toggle w-dropdown-toggle">
									<div className="icon w-icon-dropdown-toggle" />
									<div className="paragraph">{t("qa-3")}</div>
								</div>
								<nav className="w-dropdown-list">
									<a href="#" className="dropdown-link w-dropdown-link">
										{t("qa-3-text")}
							...
							>
								<div className="dropdown-toggle w-dropdown-toggle">
									<div className="icon w-icon-dropdown-toggle" />
									<div className="paragraph">{t("qa-4")}</div>
								</div>
								<nav className="w-dropdown-list">
									<a href="#" className="dropdown-link w-dropdown-link">
										{t("qa-4-text")}
						...
						<div className="w-layout-hflex pricing-box">
							{data?.getSubscriptionPrices.map((price) => (
								<div className="pricing-cards" key={price.id}>
									...
									<h3 className="h3-highlight">
										{parseToCurrency(price.unit_amount)}
									</h3>
									<div className="text-block">{price.product.description}</div>
									<Link href="business/signup">
										<a className="button small w-button">{t("select")}</a>
									</Link>
								</div>
							))}
						</div>
					...
					<div className="content-container">
						<div className="column-3 w-row">
							...
							<div className="w-col w-col-4">
								...
								<a
									href="mailto:fasto.contact@gmail.com"
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
	return {
		props: {
			...(await serverSideTranslations(locale ?? "en", ["landingPage"])),
		},
	};
};
