...
export const CustomerLayout: React.FC = ({ children }) => {
	...
	const isMenu =
		router.pathname === customerRoute["/customer/[businessId]/menu"];
	const isSettings =
		router.pathname === customerRoute["/customer/[businessId]/settings"];
	const isCart =
		router.pathname === customerRoute["/customer/[businessId]/cart"];
