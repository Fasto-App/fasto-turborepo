...
import {
	...
	GetIsConnectdQuery,
	IsoCountry,
	useConnectExpressPaymentMutation,
	useCreateStripeAccessLinkLazyQuery,
	useGenerateStripePayoutMutation,
	useGetBusinessInformationQuery,
	useGetIsConnectdQuery,
} from "../../gen/generated";
...
const PaymentConfig: RegularInputConfig = {
	accounttype: {
		...
		label: "Account Type",
		inputType: "Radio",
		array: typedKeys(BusinessType).map((key) => ({
			name: key,
			_id: BusinessType[key],
		})),
...
const Payouts = ({
	...
	const [generatePayout, { loading: loadingPayout }] =
		useGenerateStripePayoutMutation({
	...
	return (
		...
		>
			...
			<VStack justifyContent={"space-between"}>
				...
				<Text fontSize="xl">{parseToCurrency(balancePending)}</Text>
