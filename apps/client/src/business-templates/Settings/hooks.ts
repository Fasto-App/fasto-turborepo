...
export const useManageBusinessFormHook = (
	data?: GetBusinessInformationQuery["getBusinessInformation"] | null,
) => {
...
export const useManageLocationFormHook = (
	data?: GetBusinessLocationQuery["getBusinessLocation"] | null,
) => {
...
export const useManageAccountFormHook = (
	data?: GetUserInformationQuery["getUserInformation"] | null,
) => {
