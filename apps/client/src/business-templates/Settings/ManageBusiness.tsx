...
export const ManageBusiness = () => {
	const { daysOfTheWeek, setCloseHour, setOpenHour, toggleDay } =
		useScheduleStore(
			(state) => ({
	...
	const [updateBusinessInformationMutation, { loading }] =
		useUpdateBusinessInformationMutation({
	...
	const handleSaveAccountInfo = async (
		values: businessInformationSchemaInput,
	) => {
		setScheduleError(undefined);

		try {
			const validateDaysOfTheWeek =
				await hoursOfOperationSchema.parseAsync(daysOfTheWeek);
