...
export type ResolversTypes = {
	...
	OrdersGroup: ResolverTypeWrapper<OrdersGroup>;
...
export type AccountCreationResponseResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["AccountCreationResponse"] = ResolversParentTypes["AccountCreationResponse"],
> = {
...
export type AutoCompleteResResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["AutoCompleteRes"] = ResolversParentTypes["AutoCompleteRes"],
> = {
...
export type AveragePerDayResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["AveragePerDay"] = ResolversParentTypes["AveragePerDay"],
> = {
...
> = {
	...
	employees?: Resolver<
		...
		ContextType
	>;
	hoursOfOperation?: Resolver<
		Maybe<ResolversTypes["HoursOfOperation"]>,
		ParentType,
		ContextType
	>;
	menus?: Resolver<
...
export type BusinessPrivilegesResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["BusinessPrivileges"] = ResolversParentTypes["BusinessPrivileges"],
> = {
	business?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
	privilege?: Resolver<
		ResolversTypes["UserPrivileges"],
		ParentType,
		ContextType
	>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
> = {
	...
	orders?: Resolver<
		Array<Maybe<ResolversTypes["OrderDetail"]>>,
		ParentType,
		ContextType
	>;
	paid?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
	payments?: Resolver<
		Array<Maybe<ResolversTypes["Payment"]>>,
		ParentType,
		ContextType
	>;
	...
	splitType?: Resolver<
		Maybe<ResolversTypes["SplitType"]>,
		ParentType,
		ContextType
	>;
	status?: Resolver<
		ResolversTypes["CheckoutStatusKeys"],
		ParentType,
		ContextType
	>;
	subTotal?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
...
export type ClientSessionResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["ClientSession"] = ResolversParentTypes["ClientSession"],
> = {
...
export type CreateBusinessPayloadResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["CreateBusinessPayload"] = ResolversParentTypes["CreateBusinessPayload"],
> = {
...
export type CreateSubResponseResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["CreateSubResponse"] = ResolversParentTypes["CreateSubResponse"],
> = {
...
export type DefaultPaymentMethodResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["DefaultPaymentMethod"] = ResolversParentTypes["DefaultPaymentMethod"],
> = {
	card?: Resolver<Maybe<ResolversTypes["Card"]>, ParentType, ContextType>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DeleteBusinessPayloadResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["DeleteBusinessPayload"] = ResolversParentTypes["DeleteBusinessPayload"],
> = {
...
export type EmployeesResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["Employees"] = ResolversParentTypes["Employees"],
> = {
	employees?: Resolver<
...
export type HoursResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["Hours"] = ResolversParentTypes["Hours"],
> = {
...
export type HoursOfOperationResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["HoursOfOperation"] = ResolversParentTypes["HoursOfOperation"],
> = {
...
> = {
	...
	name?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
	sections?: Resolver<
		Maybe<Array<ResolversTypes["Section"]>>,
		ParentType,
		ContextType
	>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
> = {
	...
	>;
	acceptTabRequest?: Resolver<
		Maybe<ResolversTypes["Request"]>,
		ParentType,
		ContextType,
		RequireFields<MutationAcceptTabRequestArgs, "input">
	>;
	addItemToCart?: Resolver<
		ResolversTypes["CartItem"],
		ParentType,
		ContextType,
		RequireFields<MutationAddItemToCartArgs, "input">
	>;
	cancelSubscription?: Resolver<
		ResolversTypes["StripeSubscription"],
		ParentType,
		ContextType,
		RequireFields<MutationCancelSubscriptionArgs, "input">
	>;
	clientCreateMultipleOrderDetails?: Resolver<
		Array<ResolversTypes["OrderDetail"]>,
		ParentType,
		ContextType,
		RequireFields<MutationClientCreateMultipleOrderDetailsArgs, "input">
	>;
	...
	>;
	connectExpressPayment?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationConnectExpressPaymentArgs, "input">
	>;
	createBusiness?: Resolver<
		Maybe<ResolversTypes["CreateBusinessPayload"]>,
		ParentType,
		ContextType,
	...
	createCategory?: Resolver<
		...
		ParentType,
		ContextType,
		Partial<MutationCreateCategoryArgs>
	>;
	...
	createEmployeeAccount?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationCreateEmployeeAccountArgs, "input">
	>;
	createMenu?: Resolver<
		ResolversTypes["Menu"],
		ParentType,
	...
	>;
	createMultipleOrderDetails?: Resolver<
		Array<ResolversTypes["OrderDetail"]>,
		ParentType,
		ContextType,
		RequireFields<MutationCreateMultipleOrderDetailsArgs, "input">
	>;
	createNewTakeoutOrDelivery?: Resolver<
		ResolversTypes["String"],
		ParentType,
		ContextType,
		RequireFields<MutationCreateNewTakeoutOrDeliveryArgs, "input">
	>;
	createOrdersCheckout?: Resolver<
		ResolversTypes["Checkout"],
		ParentType,
		ContextType,
		RequireFields<MutationCreateOrdersCheckoutArgs, "input">
	>;
	...
	createSpace?: Resolver<
		...
		ParentType,
		ContextType,
		Partial<MutationCreateSpaceArgs>
	>;
	createSubscription?: Resolver<
		ResolversTypes["CreateSubResponse"],
		ParentType,
		ContextType,
	...
	createTab?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationCreateTabArgs, "input">
	>;
	createTable?: Resolver<
		ResolversTypes["Table"],
		ParentType,
		ContextType,
		Partial<MutationCreateTableArgs>
	>;
	createUser?: Resolver<
		ResolversTypes["User"],
		ParentType,
	...
	>;
	customerRequestPayFull?: Resolver<
		ResolversTypes["Checkout"],
		ParentType,
		ContextType,
		RequireFields<MutationCustomerRequestPayFullArgs, "input">
	>;
	customerRequestSplit?: Resolver<
		ResolversTypes["Checkout"],
		ParentType,
		ContextType,
		RequireFields<MutationCustomerRequestSplitArgs, "input">
	>;
	declineInvitation?: Resolver<
		ResolversTypes["Request"],
		ParentType,
		ContextType,
		RequireFields<MutationDeclineInvitationArgs, "input">
	>;
	declineTabRequest?: Resolver<
		ResolversTypes["Request"],
		ParentType,
		ContextType,
		RequireFields<MutationDeclineTabRequestArgs, "input">
	>;
	deleteBusiness?: Resolver<
		Maybe<ResolversTypes["DeleteBusinessPayload"]>,
		ParentType,
		ContextType,
		RequireFields<MutationDeleteBusinessArgs, "businessID">
	>;
	deleteBusinessEmployee?: Resolver<
		ResolversTypes["ID"],
		ParentType,
		ContextType,
		RequireFields<MutationDeleteBusinessEmployeeArgs, "input">
	>;
	deleteCategory?: Resolver<
		Maybe<ResolversTypes["RequestResponseOK"]>,
		ParentType,
		ContextType,
		RequireFields<MutationDeleteCategoryArgs, "id">
	>;
	deleteCheckoutData?: Resolver<
		ResolversTypes["DeleteResult"],
		ParentType,
		ContextType,
		RequireFields<MutationDeleteCheckoutDataArgs, "ids">
	>;
	deleteItemFromCart?: Resolver<
		ResolversTypes["CartItem"],
		ParentType,
		ContextType,
		RequireFields<MutationDeleteItemFromCartArgs, "input">
	>;
	deleteMenu?: Resolver<
		ResolversTypes["Menu"],
		ParentType,
	...
	>;
	deleteOrdersGroupData?: Resolver<
		ResolversTypes["DeleteResult"],
		ParentType,
		ContextType,
		RequireFields<MutationDeleteOrdersGroupDataArgs, "ids">
	>;
	...
	deleteSpace?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationDeleteSpaceArgs, "input">
	>;
	deleteTab?: Resolver<
		Maybe<ResolversTypes["Tab"]>,
		ParentType,
		ContextType,
		RequireFields<MutationDeleteTabArgs, "input">
	>;
	deleteTable?: Resolver<
		ResolversTypes["RequestResponseOK"],
		ParentType,
		ContextType,
		Partial<MutationDeleteTableArgs>
	>;
	deleteUser?: Resolver<
		ResolversTypes["RequestResponseOK"],
		ParentType,
		ContextType
	>;
	generatePaymentIntent?: Resolver<
		ResolversTypes["PaymentIntent"],
		ParentType,
		ContextType,
		RequireFields<MutationGeneratePaymentIntentArgs, "input">
	>;
	generateStripePayout?: Resolver<
		ResolversTypes["Boolean"],
		ParentType,
		ContextType
	>;
	linkCategoryToProducts?: Resolver<
		Maybe<ResolversTypes["Category"]>,
		ParentType,
		ContextType,
		RequireFields<MutationLinkCategoryToProductsArgs, "input">
	>;
	makeCheckoutFullPayment?: Resolver<
		ResolversTypes["Checkout"],
		ParentType,
		ContextType,
		RequireFields<MutationMakeCheckoutFullPaymentArgs, "input">
	>;
	makeCheckoutPayment?: Resolver<
		ResolversTypes["Checkout"],
		ParentType,
		ContextType,
		RequireFields<MutationMakeCheckoutPaymentArgs, "input">
	>;
	manageBusinessEmployees?: Resolver<
		ResolversTypes["Employee"],
		ParentType,
		ContextType,
		RequireFields<MutationManageBusinessEmployeesArgs, "input">
	>;
	openTabRequest?: Resolver<
		Maybe<ResolversTypes["String"]>,
		ParentType,
		ContextType,
		RequireFields<MutationOpenTabRequestArgs, "input">
	>;
	passwordReset?: Resolver<
		ResolversTypes["User"],
		ParentType,
		ContextType,
		RequireFields<MutationPasswordResetArgs, "input">
	>;
	postUserLogin?: Resolver<
		ResolversTypes["User"],
		ParentType,
		ContextType,
		RequireFields<MutationPostUserLoginArgs, "input">
	>;
	...
	>;
	requestCloseTab?: Resolver<
		ResolversTypes["Tab"],
		ParentType,
		ContextType,
		Partial<MutationRequestCloseTabArgs>
	>;
	requestJoinTab?: Resolver<
		Maybe<ResolversTypes["String"]>,
		ParentType,
		ContextType,
		RequireFields<MutationRequestJoinTabArgs, "input">
	>;
	requestUserAccountCreation?: Resolver<
		ResolversTypes["AccountCreationResponse"],
		ParentType,
		ContextType,
		RequireFields<MutationRequestUserAccountCreationArgs, "input">
	>;
	shareQRCode?: Resolver<
		ResolversTypes["Boolean"],
		ParentType,
		ContextType,
		RequireFields<MutationShareQrCodeArgs, "input">
	>;
	...
	>;
	updateBusinessInformation?: Resolver<
		ResolversTypes["Business"],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateBusinessInformationArgs, "input">
	>;
	updateBusinessLocation?: Resolver<
		ResolversTypes["Business"],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateBusinessLocationArgs, "input">
	>;
	updateBusinessToken?: Resolver<
		Maybe<ResolversTypes["String"]>,
		ParentType,
		ContextType,
		Partial<MutationUpdateBusinessTokenArgs>
	>;
	updateCategory?: Resolver<
		Maybe<ResolversTypes["Category"]>,
		ParentType,
		ContextType,
		Partial<MutationUpdateCategoryArgs>
	>;
	updateCustomerUpdateTabType?: Resolver<
		Maybe<ResolversTypes["Tab"]>,
		ParentType,
		ContextType,
		RequireFields<MutationUpdateCustomerUpdateTabTypeArgs, "input">
	>;
	updateItemFromCart?: Resolver<
		ResolversTypes["CartItem"],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateItemFromCartArgs, "input">
	>;
	updateMenu?: Resolver<
		Maybe<ResolversTypes["Menu"]>,
		ParentType,
		ContextType,
		Partial<MutationUpdateMenuArgs>
	>;
	updateMenuInfo?: Resolver<
		ResolversTypes["Menu"],
		ParentType,
		ContextType,
		Partial<MutationUpdateMenuInfoArgs>
	>;
	updateOrderDetail?: Resolver<
		ResolversTypes["OrderDetail"],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateOrderDetailArgs, "input">
	>;
	updateOrderGroupData?: Resolver<
		ResolversTypes["OrdersGroup"],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateOrderGroupDataArgs, "input">
	>;
	updateProductByID?: Resolver<
		ResolversTypes["Product"],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateProductByIdArgs, "input">
	>;
	...
	updateTab?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationUpdateTabArgs, "input">
	>;
	updateUserInformation?: Resolver<
		ResolversTypes["User"],
		ParentType,
		ContextType,
		RequireFields<MutationUpdateUserInformationArgs, "input">
	>;
	uploadFile?: Resolver<
		ResolversTypes["String"],
		ParentType,
...
export type OrderDetailResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["OrderDetail"] = ResolversParentTypes["OrderDetail"],
> = {
	_id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
	message?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
	product?: Resolver<ResolversTypes["Product"], ParentType, ContextType>;
...
export type OrderDetailsByDateResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["OrderDetailsByDate"] = ResolversParentTypes["OrderDetailsByDate"],
> = {
	_id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
export type OrdersGroupResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["OrdersGroup"] = ResolversParentTypes["OrdersGroup"],
> = {
	_id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
	business?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
	...
	status?: Resolver<ResolversTypes["OrderStatus"], ParentType, ContextType>;
	type?: Resolver<
		ResolversTypes["TakeoutDeliveryDineIn"],
		ParentType,
		ContextType
	>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type PaidCheckoutResResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["PaidCheckoutRes"] = ResolversParentTypes["PaidCheckoutRes"],
> = {
	data?: Resolver<
		Array<Maybe<ResolversTypes["AveragePerDay"]>>,
		ParentType,
		ContextType
	>;
...
> = {
	_empty?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
	createStripeAccessLink?: Resolver<
		Maybe<ResolversTypes["String"]>,
		ParentType,
		ContextType
	>;
	getAddress?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<QueryGetAddressArgs, "id">
	>;
	getAllBusiness?: Resolver<
		Array<Maybe<ResolversTypes["Business"]>>,
		ParentType,
		ContextType
	>;
	getAllBusinessByUser?: Resolver<
		Array<Maybe<ResolversTypes["Business"]>>,
		ParentType,
		ContextType
	>;
	getAllCategoriesByBusiness?: Resolver<
		Array<ResolversTypes["Category"]>,
		ParentType,
		ContextType
	>;
	getAllEmployees?: Resolver<
		ResolversTypes["Employees"],
		ParentType,
		ContextType
	>;
	getAllMenus?: Resolver<
		Array<ResolversTypes["Menu"]>,
		ParentType,
		ContextType
	>;
	getAllMenusByBusinessID?: Resolver<
		Array<ResolversTypes["Menu"]>,
		ParentType,
		ContextType
	>;
	getAllOpenTabsByBusinessID?: Resolver<
		Maybe<Array<Maybe<ResolversTypes["Tab"]>>>,
		ParentType,
		ContextType
	>;
	getAllOrderDetailsByDate?: Resolver<
		Maybe<Array<Maybe<ResolversTypes["OrderDetailsByDate"]>>>,
		ParentType,
		ContextType
	>;
	getAllOrderDetailsByOrderID?: Resolver<
		Maybe<Array<Maybe<ResolversTypes["OrderDetail"]>>>,
		ParentType,
		ContextType,
		RequireFields<QueryGetAllOrderDetailsByOrderIdArgs, "orderID">
	>;
	getAllProductsByBusinessID?: Resolver<
		Array<ResolversTypes["Product"]>,
		ParentType,
		ContextType
	>;
	getAllTabsByBusinessID?: Resolver<
		Maybe<Array<Maybe<ResolversTypes["Tab"]>>>,
		ParentType,
		ContextType
	>;
	getAllUsers?: Resolver<
		...
		ContextType
	>;
	getBusinessById?: Resolver<
		ResolversTypes["Business"],
		ParentType,
		ContextType,
		RequireFields<QueryGetBusinessByIdArgs, "input">
	>;
	getBusinessInformation?: Resolver<
		ResolversTypes["Business"],
		ParentType,
		ContextType
	>;
	getBusinessLocation?: Resolver<
		Maybe<ResolversTypes["Address"]>,
		ParentType,
		ContextType
	>;
	getCartItemsPerTab?: Resolver<
	...
	getCategoryByID?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<QueryGetCategoryByIdArgs, "id">
	>;
	getCheckoutByID?: Resolver<
		ResolversTypes["Checkout"],
		ParentType,
		ContextType,
		RequireFields<QueryGetCheckoutByIdArgs, "input">
	>;
	getCheckoutsByBusiness?: Resolver<
		Array<ResolversTypes["Checkout"]>,
		ParentType,
		ContextType,
		RequireFields<QueryGetCheckoutsByBusinessArgs, "page" | "pageSize">
	>;
	getClientInformation?: Resolver<
		ResolversTypes["User"],
		ParentType,
		ContextType
	>;
	getClientMenu?: Resolver<
		Maybe<ResolversTypes["Menu"]>,
		ParentType,
		ContextType,
		RequireFields<QueryGetClientMenuArgs, "input">
	>;
	getClientSession?: Resolver<
		ResolversTypes["ClientSession"],
		ParentType,
		ContextType
	>;
	getGoogleAutoComplete?: Resolver<
		Array<ResolversTypes["AutoCompleteRes"]>,
		ParentType,
		ContextType,
		RequireFields<QueryGetGoogleAutoCompleteArgs, "input">
	>;
	getIsConnected?: Resolver<
		Maybe<ResolversTypes["Balance"]>,
		ParentType,
		ContextType
	>;
	getMenuByID?: Resolver<
		ResolversTypes["Menu"],
		ParentType,
		ContextType,
		Partial<QueryGetMenuByIdArgs>
	>;
	getMostSellingProducts?: Resolver<
		Maybe<Array<Maybe<ResolversTypes["Product"]>>>,
		ParentType,
		ContextType
	>;
	getOrderDetailByID?: Resolver<
		Maybe<ResolversTypes["OrderDetail"]>,
		ParentType,
		ContextType,
		RequireFields<QueryGetOrderDetailByIdArgs, "orderDetailID">
	>;
	getOrderGroupById?: Resolver<
		ResolversTypes["OrdersGroup"],
		ParentType,
		ContextType,
		RequireFields<QueryGetOrderGroupByIdArgs, "id">
	>;
	getOrdersByCheckout?: Resolver<
		ResolversTypes["Checkout"],
		ParentType,
		ContextType,
		RequireFields<QueryGetOrdersByCheckoutArgs, "input">
	>;
	getOrdersBySession?: Resolver<
		Array<ResolversTypes["OrderDetail"]>,
		ParentType,
		ContextType
	>;
	getOrdersGroup?: Resolver<
		Maybe<Array<ResolversTypes["OrdersGroup"]>>,
		ParentType,
		ContextType,
		RequireFields<QueryGetOrdersGroupArgs, "input">
	>;
	getPaidCheckoutByDate?: Resolver<
		Maybe<ResolversTypes["PaidCheckoutRes"]>,
		ParentType,
		ContextType,
		RequireFields<QueryGetPaidCheckoutByDateArgs, "input">
	>;
	getPaymentInformation?: Resolver<
		ResolversTypes["Payment"],
		ParentType,
		ContextType,
		RequireFields<QueryGetPaymentInformationArgs, "input">
	>;
	getPendingInvitations?: Resolver<
	...
	getProductByID?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<QueryGetProductByIdArgs, "productID">
	>;
	getSignUpSubscription?: Resolver<
		Maybe<ResolversTypes["StripeSubscription"]>,
		ParentType,
		ContextType
	>;
	getSpacesFromBusiness?: Resolver<
		Maybe<Array<ResolversTypes["Space"]>>,
		ParentType,
		ContextType
	>;
	getSubscriptionPrices?: Resolver<
		Array<ResolversTypes["Price"]>,
		ParentType,
		ContextType,
		Partial<QueryGetSubscriptionPricesArgs>
	>;
	getTabByID?: Resolver<
		ResolversTypes["Tab"],
		ParentType,
		ContextType,
		RequireFields<QueryGetTabByIdArgs, "input">
	>;
	getTabRequest?: Resolver<ResolversTypes["Request"], ParentType, ContextType>;
	getTabRequests?: Resolver<
		Array<ResolversTypes["Request"]>,
		ParentType,
		ContextType,
		Partial<QueryGetTabRequestsArgs>
	>;
	getTableById?: Resolver<
		ResolversTypes["Table"],
		ParentType,
		ContextType,
		RequireFields<QueryGetTableByIdArgs, "input">
	>;
	getTablesFromSpace?: Resolver<
		Array<ResolversTypes["Table"]>,
		ParentType,
		ContextType,
		RequireFields<QueryGetTablesFromSpaceArgs, "input">
	>;
...
export type RequestResponseOkResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["RequestResponseOK"] = ResolversParentTypes["RequestResponseOK"],
> = {
...
export type SectionResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["Section"] = ResolversParentTypes["Section"],
> = {
...
> = {
	...
	name?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
	tables?: Resolver<
		Maybe<Array<ResolversTypes["Table"]>>,
		ParentType,
		ContextType
	>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type StripeProductResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["StripeProduct"] = ResolversParentTypes["StripeProduct"],
> = {
	description?: Resolver<
		Maybe<ResolversTypes["String"]>,
		ParentType,
...
> = {
	...
	numberIncremented?: SubscriptionResolver<
		...
		ContextType
	>;
	onTabRequest?: SubscriptionResolver<
		ResolversTypes["Request"],
		"onTabRequest",
		ParentType,
		ContextType
	>;
	onTabRequestResponse?: SubscriptionResolver<
		ResolversTypes["Request"],
...
export type SubscriptionDataResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["SubscriptionData"] = ResolversParentTypes["SubscriptionData"],
> = {
	price?: Resolver<ResolversTypes["Price"], ParentType, ContextType>;
	__isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionItemResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["SubscriptionItem"] = ResolversParentTypes["SubscriptionItem"],
> = {
	data?: Resolver<
...
export type TabResolvers<
	ContextType = Context,
	ParentType extends ResolversParentTypes["Tab"] = ResolversParentTypes["Tab"],
> = {
	_id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
	...
	type?: Resolver<
		Maybe<ResolversTypes["TakeoutDeliveryDineIn"]>,
		ParentType,
		ContextType
	>;
	users?: Resolver<
...
> = {
	...
	address?: Resolver<Maybe<ResolversTypes["Address"]>, ParentType, ContextType>;
	businesses?: Resolver<
		Array<ResolversTypes["BusinessPrivileges"]>,
		ParentType,
		ContextType
	>;
...
export type WorkingHoursResolvers<
	ContextType = Context,
	ParentType extends
		ResolversParentTypes["WorkingHours"] = ResolversParentTypes["WorkingHours"],
> = {
