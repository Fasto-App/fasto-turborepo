export const typedKeys = <T extends {}>(obj?: T) =>
	Object.keys(obj ?? {}) as Array<keyof T>;
export const typedValues = <T extends {}>(obj?: T) =>
...
export const getPercentageOfValue = (value: number, percentage: number) => {
	return Math.trunc(
		Math.floor(value * percentage) / FIXED_POINT_FACTOR_PERCENTAGE,
	);
};
...
export const DICE_BEAR_INITIALS_URL = (name: string) =>
